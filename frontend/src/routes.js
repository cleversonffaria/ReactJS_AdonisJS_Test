...
const BrandButtons = React.lazy(() =>
  import("./views/admin/Buttons/BrandButtons")
);
const ButtonDropdowns = React.lazy(() =>
  import("./views/admin/Buttons/ButtonDropdowns")
);
const ButtonGroups = React.lazy(() =>
  import("./views/admin/Buttons/ButtonGroups")
);
...
const SimpleLineIcons = React.lazy(() =>
  import("./views/admin/Icons/SimpleLineIcons")
);
