...
const loading = () => (<div className="animated fadeIn pt-3 text-center loading" >
  <i className="fa fa-refresh fa-spin"> </i> Carregando... </div>
);
// Containers
...
const Login = React.lazy(() =>
  import("./views/admin/Pages/Login"));
const Register = React.lazy(() =>
  import("./views/admin/Pages/Register"));
// const Page404 = React.lazy(() => import("./views/admin/Pages/Page404"));
const Page500 = React.lazy(() =>
  import("./views/admin/Pages/Page500"));
  ...
  return (<HashRouter >
    <Provider store={store} >
      <React.Suspense fallback={loading()}>
        <Switch>
          <Route exact path="/login" name="Login Page" render={props => < Login setstatus={setstatus} {...props} />} />
          ...
          <Route path="/admin" name="Admin" render={props => <DefaultLayout {...props} />} />
          <Route path="/" name="Home" render={props => < Site {...props} />} />
          { /* <Route path="/products/:page?/:count" render={props => <Site {...props} />} /> */} { /* <Route path="*" render={props => <Page404 {...props} />} /> */}
        </Switch>
      </React.Suspense>
    </Provider>
  </HashRouter>
